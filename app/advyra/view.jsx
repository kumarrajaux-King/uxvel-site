...
export default function AdvyraView() {
  ...
  return (
    ...
    <div data-r="1" data-r-now="1" data-r-d="60" style={{font: 'var(--weight-semibold) 11.5px/1 var(--font-sans)', letterSpacing: '.28em', textTransform: 'uppercase', color: 'var(--c-accent,#4DA6FF)'}}>Luxury e-commerce, Shopify, lifestyle</div>
