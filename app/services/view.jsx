...
export default function ServicesView() {
  ...
  return (
    ...
    <section data-screen-label="Services hero" data-hero-pad="1" style={{position: 'relative', zIndex: '1', minHeight: '64vh', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', background: 'var(--c-services,linear-gradient(180deg,#0E1413 0%,#17211F 100%))', borderBottom: '1px solid var(--c-line2,rgba(255,255,255,.10))'}}>
    ...
    <div data-r="1" data-r-now="1" style={{font: 'var(--weight-semibold) 11.5px/1 var(--font-sans)', letterSpacing: '.28em', textTransform: 'uppercase', color: 'var(--c-accent,#6BD5C6)'}}>One partner. Every stage of growth.</div>
    ...
    <div data-r="1" data-card="1" id="research" data-cursor="grow" style={{background: 'var(--c-card,#0E1413)', padding: 'clamp(28px,3vw,46px)', display: 'flex', flexDirection: 'column', gap: '20px', minHeight: 'clamp(280px,29vw,372px)', transition: 'background .5s ease'}} className="uxvh5">
    ...
    <div data-r="1" data-r-d="70" data-card="1" id="ux" data-cursor="grow" style={{background: 'var(--c-card,#0E1413)', padding: 'clamp(28px,3vw,46px)', display: 'flex', flexDirection: 'column', gap: '20px', minHeight: 'clamp(280px,29vw,372px)', transition: 'background .5s ease'}} className="uxvh5">
    ...
    <div data-r="1" data-r-d="140" data-card="1" id="design" data-cursor="grow" style={{background: 'var(--c-card,#0E1413)', padding: 'clamp(28px,3vw,46px)', display: 'flex', flexDirection: 'column', gap: '20px', minHeight: 'clamp(280px,29vw,372px)', transition: 'background .5s ease'}} className="uxvh5">
    ...
    <div data-r="1" data-card="1" id="development" data-cursor="grow" style={{background: 'var(--c-card,#0E1413)', padding: 'clamp(28px,3vw,46px)', display: 'flex', flexDirection: 'column', gap: '20px', minHeight: 'clamp(280px,29vw,372px)', transition: 'background .5s ease'}} className="uxvh5">
    ...
    <div data-r="1" data-r-d="70" data-card="1" id="marketing" data-cursor="grow" style={{background: 'var(--c-card,#0E1413)', padding: 'clamp(28px,3vw,46px)', display: 'flex', flexDirection: 'column', gap: '20px', minHeight: 'clamp(280px,29vw,372px)', transition: 'background .5s ease'}} className="uxvh5">
    ...
    <div data-r="1" data-r-d="140" data-card="1" id="growth" data-cursor="grow" style={{background: 'var(--c-card,#0E1413)', padding: 'clamp(28px,3vw,46px)', display: 'flex', flexDirection: 'column', gap: '20px', minHeight: 'clamp(280px,29vw,372px)', transition: 'background .5s ease'}} className="uxvh5">
