...
export default function NotFound() {
  return (
    <main style={{ minHeight: '100svh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '22px', padding: '40px 24px', background: 'var(--c-bg,#0E1413)', textAlign: 'center' }}>
      ...
      <Link href="/" style={{ font: 'var(--weight-semibold) 13px/1 var(--font-sans)', letterSpacing: '.04em', color: 'var(--c-on-accent,#17211F)', background: 'var(--c-accent,#6BD5C6)', borderRadius: '999px', padding: '17px 26px' }}>Back to home</Link>
    </main>
  );
}
