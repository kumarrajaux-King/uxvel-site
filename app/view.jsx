...
export default function HomeView() {
  ...
  return (
    <div ref={rootRef} style={{position: 'relative', background: 'var(--c-bg,#0B1220)', color: 'var(--c-body,var(--c-body,rgba(255,255,255,.62)))', fontFamily: 'var(--font-sans)'}}>
    ...
    <div style={{position: 'fixed', top: '0', left: '0', width: '100%', height: '100vh', zIndex: '0', pointerEvents: 'none', background: 'var(--c-hero,linear-gradient(90deg,rgba(9,15,24,.86) 0%,rgba(9,15,24,.52) 44%,rgba(9,15,24,.18) 100%))'}}></div>
    ...
    <h1 style={{display: 'flex', flexWrap: 'wrap', gap: '0.25em', fontFamily: '\'Instrument Serif\',Georgia,serif', fontSize: 'clamp(26px,3vw,42px)', fontWeight: '400', lineHeight: '1.08', letterSpacing: '.005em', textTransform: 'uppercase', color: 'var(--c-h,#fff)', margin: '0'}}>
    ...
    <Link href="/contact" data-cursor="grow" data-mag="0.3" style={{display: 'inline-flex', alignItems: 'center', gap: '10px', background: 'var(--c-accent,#4DA6FF)', color: 'var(--c-on-accent,#121C2B)', font: 'var(--weight-semibold) 14px/1 var(--font-sans)', letterSpacing: '.04em', padding: '18px 27px', borderRadius: '999px', transition: 'box-shadow .45s ease,background .35s ease'}} className="uxvh4">Start a Project<span style={{fontSize: '15px'}}>↗</span></Link>
    ...
    <span style={{font: 'var(--weight-medium) clamp(17px,1.7vw,26px)/1 var(--font-display)', letterSpacing: '-.012em', color: 'var(--c-body3,rgba(255,255,255,.66))', whiteSpace: 'nowrap'}}>Corvia Systems</span><span style={{width: '5px', height: '5px', borderRadius: '50%', background: 'var(--c-lime,#7FD8FF)', flex: 'none'}}></span>
    ...
    <div data-r="1" style={{font: 'var(--weight-semibold) 11.5px/1 var(--font-sans)', letterSpacing: '.28em', textTransform: 'uppercase', color: 'var(--c-accent,#4DA6FF)'}}>One partner. Every stage of growth.</div>
    ...
    <div data-r="1" data-card="1" data-cursor="grow" style={{background: 'var(--c-card,#0B1220)', padding: 'clamp(28px,3vw,46px)', display: 'flex', flexDirection: 'column', gap: '20px', minHeight: 'clamp(280px,29vw,372px)', transition: 'background .5s ease'}} className="uxvh5">
    ...
    <div data-r="1" data-r-d="70" data-card="1" data-cursor="grow" style={{background: 'var(--c-card,#0B1220)', padding: 'clamp(28px,3vw,46px)', display: 'flex', flexDirection: 'column', gap: '20px', minHeight: 'clamp(280px,29vw,372px)', transition: 'background .5s ease'}} className="uxvh5">
    ...
    <div data-r="1" data-r-d="140" data-card="1" data-cursor="grow" style={{background: 'var(--c-card,#0B1220)', padding: 'clamp(28px,3vw,46px)', display: 'flex', flexDirection: 'column', gap: '20px', minHeight: 'clamp(280px,29vw,372px)', transition: 'background .5s ease'}} className="uxvh5">
    ...
    <div data-r="1" style={{font: 'var(--weight-semibold) 11.5px/1 var(--font-sans)', letterSpacing: '.28em', textTransform: 'uppercase', color: 'var(--c-accent,#4DA6FF)'}}>The UXVel growth engine</div>
    ...
    <div data-r="1" style={{font: 'var(--weight-semibold) 11.5px/1 var(--font-sans)', letterSpacing: '.28em', textTransform: 'uppercase', color: 'var(--c-accent,#4DA6FF)'}}>Selected work. Built for momentum.</div>
    ...
    <span style={{font: 'var(--weight-semibold) clamp(15px,1.3vw,19px)/1 var(--font-display)', color: 'var(--c-h,#fff)'}}>Corvia Systems</span>
    ...
    <img src="/work/techouts-1.jpg" alt="Corvia Systems project cover" loading="lazy" style={{position: 'absolute', inset: '0', width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} />
    </div>
    </Link>
    ...
    <span style={{font: 'var(--weight-medium) 11.5px/1 var(--font-sans)', letterSpacing: '.16em', textTransform: 'uppercase', color: 'var(--c-inv-ac,#1B6FD6)'}}>Corvia Systems</span>
    </div>
    ...
    <Link href="/techouts" style={{fontSize: '14.5px', color: 'rgba(255,255,255,.62)'}}>Corvia Systems</Link>
