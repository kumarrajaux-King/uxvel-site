...
export default function WorkView() {
  ...
  return (
    ...
    <section data-screen-label="Work hero" data-hero-pad="1" style={{position: 'relative', zIndex: '1', minHeight: '64vh', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', background: 'var(--c-services,linear-gradient(180deg,#0E1413 0%,#17211F 100%))', borderBottom: '1px solid var(--c-line2,rgba(255,255,255,.10))'}}>
    ...
    <div data-r="1" data-r-now="1" style={{font: 'var(--weight-semibold) 11.5px/1 var(--font-sans)', letterSpacing: '.28em', textTransform: 'uppercase', color: 'var(--c-accent,#6BD5C6)'}}>Selected work. Built for momentum.</div>
