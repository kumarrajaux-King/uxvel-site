...
export default function ContactView() {
  ...
  return (
    ...
    <section data-screen-label="Contact hero" data-hero-pad="1" style={{position: 'relative', zIndex: '1', minHeight: '64vh', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', background: 'var(--c-services,linear-gradient(180deg,#0B1220 0%,#121C2B 100%))', borderBottom: '1px solid var(--c-line2,rgba(255,255,255,.10))'}}>
    ...
    <div data-r="1" data-r-now="1" style={{font: 'var(--weight-semibold) 11.5px/1 var(--font-sans)', letterSpacing: '.28em', textTransform: 'uppercase', color: 'var(--c-accent,#4DA6FF)'}}>Bring us the problem before you bring us the brief.</div>
    ...
    <section data-screen-label="Contact detail" style={{position: 'relative', zIndex: '1', padding: 'clamp(70px,10vh,140px) clamp(20px,5vw,72px) clamp(80px,12vh,160px)', background: 'var(--c-bg,#0B1220)'}}>
    ...
    <div style={{font: 'var(--weight-semibold) 11.5px/1 var(--font-sans)', letterSpacing: '.28em', textTransform: 'uppercase', color: 'var(--c-accent,#4DA6FF)'}}>Start with the challenge</div>
    ...
    <button onClick={sendBrief} data-cursor="grow" data-mag="0.3" style={{alignSelf: 'flex-start', display: 'inline-flex', alignItems: 'center', gap: '10px', background: 'var(--c-accent,#4DA6FF)', color: 'var(--c-on-accent,#121C2B)', font: 'var(--weight-semibold) 14px/1 var(--font-sans)', letterSpacing: '.04em', padding: '18px 27px', border: '0', borderRadius: '999px', cursor: 'pointer', transition: 'box-shadow .45s ease,background .35s ease'}} className="uxvh10">Send the brief<span style={{fontSize: '15px'}}>↗</span></button>
