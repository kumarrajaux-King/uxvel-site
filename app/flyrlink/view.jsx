...
export default function FlyrlinkView() {
  ...
  return (
    ...
    <div data-r="1" data-r-now="1" style={{display: 'flex', alignItems: 'center', gap: '8px', font: 'var(--weight-medium) 11.5px/1 var(--font-mono)', letterSpacing: '.06em', color: 'var(--c-muted,rgba(255,255,255,.38))'}}><Link href="/" data-cursor="grow" style={{color: 'var(--c-muted,rgba(255,255,255,.38))'}}>Home</Link><span>/</span><Link href="/work" data-cursor="grow" style={{color: 'var(--c-muted,rgba(255,255,255,.38))'}}>Work</Link><span>/</span><span style={{color: 'var(--c-body2,rgba(255,255,255,.56))'}}>Flyrlink</span></div>
    <div data-r="1" data-r-now="1" data-r-d="60" style={{font: 'var(--weight-semibold) 11.5px/1 var(--font-sans)', letterSpacing: '.28em', textTransform: 'uppercase', color: 'var(--c-accent,#4DA6FF)'}}>Marketplace, booking, expert economy</div>
    <h1 data-r="1" data-r-now="1" data-r-d="120" style={{fontFamily: '\'Instrument Serif\',Georgia,serif', fontWeight: '400', fontSize: 'clamp(34px,5.2vw,76px)', lineHeight: '1.04', letterSpacing: '-.008em', color: 'var(--c-h,#fff)', margin: '0', textWrap: 'balance', maxWidth: '20ch'}}>Making Expertise Instantly Accessible</h1>
    <p data-r="1" data-r-now="1" data-r-d="180" style={{font: 'var(--weight-regular) clamp(15px,1.2vw,18px)/1.7 var(--font-sans)', color: 'var(--c-body,rgba(255,255,255,.62))', maxWidth: '58ch'}}>UXVel shaped Flyrlink around trust before transaction, giving clients a clear path to the right expert and professionals a simple path to build their own business.</p>
    <div data-r="1" data-r-now="1" data-r-d="240"><a href="https://flyrlink.com/" target="_blank" rel="noopener noreferrer" data-cursor="grow" data-mag="0.28" style={{display: 'inline-flex', alignItems: 'center', gap: '9px', color: 'var(--c-h,#fff)', font: 'var(--weight-medium) 13px/1 var(--font-sans)', letterSpacing: '.04em', padding: '13px 22px', borderRadius: '999px', border: '1px solid var(--c-line,rgba(255,255,255,.16))', transition: 'border-color .35s ease,background .35s ease'}} className="uxvh2">Visit Flyrlink <span>↗</span></a></div>
    </div>
    </div>
    </section>
    ...
    <div data-r="1" style={{position: 'relative', borderRadius: '16px', overflow: 'hidden', aspectRatio: '16/9', width: '100%', border: '1px solid var(--c-line2,rgba(255,255,255,.10))'}}><img src="/work/flyrlink.jpg" alt="Flyrlink case study cover" loading="lazy" style={{position: 'absolute', inset: '0', width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} /></div>
    ...
    <div style={{display: 'flex', flexDirection: 'column', gap: '8px'}}><span style={{font: 'var(--weight-semibold) 10.5px/1 var(--font-sans)', letterSpacing: '.2em', textTransform: 'uppercase', color: 'var(--c-muted,rgba(255,255,255,.38))'}}>Client</span><span style={{font: 'var(--weight-medium) 15px/1.4 var(--font-display)', color: 'var(--c-h,#fff)'}}>Flyrlink</span></div>
    <div style={{display: 'flex', flexDirection: 'column', gap: '8px'}}><span style={{font: 'var(--weight-semibold) 10.5px/1 var(--font-sans)', letterSpacing: '.2em', textTransform: 'uppercase', color: 'var(--c-muted,rgba(255,255,255,.38))'}}>Industry</span><span style={{font: 'var(--weight-regular) 14.5px/1.4 var(--font-sans)', color: 'var(--c-body,rgba(255,255,255,.62))'}}>Marketplace, booking, expert economy</span></div>
    <div style={{display: 'flex', flexDirection: 'column', gap: '8px'}}><span style={{font: 'var(--weight-semibold) 10.5px/1 var(--font-sans)', letterSpacing: '.2em', textTransform: 'uppercase', color: 'var(--c-muted,rgba(255,255,255,.38))'}}>Scope</span><span style={{font: 'var(--weight-regular) 14.5px/1.4 var(--font-sans)', color: 'var(--c-body,rgba(255,255,255,.62))'}}>Product UX, two-sided platform design, booking flow</span></div>
    <div style={{display: 'flex', flexDirection: 'column', gap: '8px'}}><span style={{font: 'var(--weight-semibold) 10.5px/1 var(--font-sans)', letterSpacing: '.2em', textTransform: 'uppercase', color: 'var(--c-muted,rgba(255,255,255,.38))'}}>Technology</span><span style={{font: 'var(--weight-regular) 14.5px/1.4 var(--font-sans)', color: 'var(--c-body,rgba(255,255,255,.62))'}}>Web platform, design system</span></div>
    </div>
    </div>
    </section>
    ...
    <p style={{font: 'var(--weight-regular) clamp(15px,1.15vw,17.5px)/1.75 var(--font-sans)', color: 'var(--c-body2,rgba(255,255,255,.56))'}}>Flyrlink is a two-sided platform connecting people with verified experts across a range of services.</p>
    </div>
    ...
    <p style={{font: 'var(--weight-regular) clamp(15px,1.15vw,17.5px)/1.75 var(--font-sans)', color: 'var(--c-body2,rgba(255,255,255,.56))'}}>Two-sided platforms live or die on trust. Clients needed confidence before they would book a stranger's time, and experts needed a path to a business, not just a listing.</p>
    </div>
    ...
    <p style={{font: 'var(--weight-regular) clamp(15px,1.15vw,17.5px)/1.75 var(--font-sans)', color: 'var(--c-body2,rgba(255,255,255,.56))'}}>The moment that mattered most was not the transaction — it was the decision just before it: can this person be trusted with my problem, and can I build something real on this platform.</p>
    </div>
    ...
    <p style={{font: 'var(--weight-regular) clamp(15px,1.15vw,17.5px)/1.75 var(--font-sans)', color: 'var(--c-body2,rgba(255,255,255,.56))'}}>UXVel shaped the experience around trust before transaction: helping clients discover, compare, book, and review, while giving experts a clear path to list, earn, and build reputation.</p>
    </div>
    </div>
    </div>
    </section>
    ...
    <div data-r="1" style={{background: 'var(--c-card,#0B1220)', padding: 'clamp(24px,2.6vw,36px)', display: 'flex', flexDirection: 'column', gap: '12px', minHeight: 'clamp(160px,16vw,200px)'}}><h3 style={{font: 'var(--weight-semibold) 15.5px/1.3 var(--font-display)', letterSpacing: '-.01em', color: 'var(--c-h,#fff)', margin: '0'}}>User journey</h3><p style={{font: 'var(--weight-regular) 14px/1.6 var(--font-sans)', color: 'var(--c-body2,rgba(255,255,255,.56))'}}>Separate, purpose-built journeys for clients and experts.</p></div>
    <div data-r="1" data-r-d="60" style={{background: 'var(--c-card,#0B1220)', padding: 'clamp(24px,2.6vw,36px)', display: 'flex', flexDirection: 'column', gap: '12px', minHeight: 'clamp(160px,16vw,200px)'}}><h3 style={{font: 'var(--weight-semibold) 15.5px/1.3 var(--font-display)', letterSpacing: '-.01em', color: 'var(--c-h,#fff)', margin: '0'}}>Information architecture</h3><p style={{font: 'var(--weight-regular) 14px/1.6 var(--font-sans)', color: 'var(--c-body2,rgba(255,255,255,.56))'}}>Discovery organized around expertise and trust signals.</p></div>
    <div data-r="1" data-r-d="120" style={{background: 'var(--c-card,#0B1220)', padding: 'clamp(24px,2.6vw,36px)', display: 'flex', flexDirection: 'column', gap: '12px', minHeight: 'clamp(160px,16vw,200px)'}}><h3 style={{font: 'var(--weight-semibold) 15.5px/1.3 var(--font-display)', letterSpacing: '-.01em', color: 'var(--c-h,#fff)', margin: '0'}}>Design system</h3><p style={{font: 'var(--weight-regular) 14px/1.6 var(--font-sans)', color: 'var(--c-body2,rgba(255,255,255,.56))'}}>Reusable profile, listing, and review components.</p></div>
    <div data-r="1" style={{background: 'var(--c-card,#0B1220)', padding: 'clamp(24px,2.6vw,36px)', display: 'flex', flexDirection: 'column', gap: '12px', minHeight: 'clamp(160px,16vw,200px)'}}><h3 style={{font: 'var(--weight-semibold) 15.5px/1.3 var(--font-display)', letterSpacing: '-.01em', color: 'var(--c-h,#fff)', margin: '0'}}>Lead / booking flow</h3><p style={{font: 'var(--weight-regular) 14px/1.6 var(--font-sans)', color: 'var(--c-body2,rgba(255,255,255,.56))'}}>A simplified path from discovery to confirmed booking.</p></div>
    </div>
    </div>
    </section>
    ...
    <div data-r="1" data-r-d="60" style={{display: 'flex', alignItems: 'center', gap: '12px', background: 'var(--c-bg2,#121C2B)', border: '1px solid var(--c-line2,rgba(255,255,255,.10))', borderRadius: '12px', padding: '20px 22px'}}><span style={{width: '7px', height: '7px', borderRadius: '50%', background: 'var(--c-accent,#4DA6FF)', flex: 'none'}}></span><span style={{font: 'var(--weight-medium) 15px/1.3 var(--font-display)', color: 'var(--c-h,#fff)'}}>Stronger trust</span></div>
    ...
    <div data-r="1" style={{display: 'flex', flexDirection: 'column', gap: '12px'}}><div style={{position: 'relative', borderRadius: '12px', overflow: 'hidden', aspectRatio: '16/10', border: '1px solid var(--c-line2,rgba(255,255,255,.10))'}}><img src="/work/flyrlink-1.jpg" alt="Expert discovery and profile" loading="lazy" style={{position: 'absolute', inset: '0', width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} /></div><span style={{font: 'var(--weight-medium) 12.5px/1.4 var(--font-sans)', color: 'var(--c-dim,rgba(255,255,255,.48))'}}>Expert discovery and profile</span></div>
    <div data-r="1" data-r-d="60" style={{display: 'flex', flexDirection: 'column', gap: '12px'}}><div style={{position: 'relative', borderRadius: '12px', overflow: 'hidden', aspectRatio: '16/10', border: '1px solid var(--c-line2,rgba(255,255,255,.10))'}}><img src="/work/flyrlink-2.jpg" alt="Booking flow" loading="lazy" style={{position: 'absolute', inset: '0', width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} /></div><span style={{font: 'var(--weight-medium) 12.5px/1.4 var(--font-sans)', color: 'var(--c-dim,rgba(255,255,255,.48))'}}>Booking flow</span></div>
    <div data-r="1" style={{display: 'flex', flexDirection: 'column', gap: '12px'}}><div style={{position: 'relative', borderRadius: '12px', overflow: 'hidden', aspectRatio: '16/10', border: '1px solid var(--c-line2,rgba(255,255,255,.10))'}}><img src="/work/flyrlink-3.jpg" alt="Design system" loading="lazy" style={{position: 'absolute', inset: '0', width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} /></div><span style={{font: 'var(--weight-medium) 12.5px/1.4 var(--font-sans)', color: 'var(--c-dim,rgba(255,255,255,.48))'}}>Design system</span></div>
    <div data-r="1" data-r-d="60" style={{display: 'flex', flexDirection: 'column', gap: '12px'}}><div style={{position: 'relative', borderRadius: '12px', overflow: 'hidden', aspectRatio: '16/10', border: '1px solid var(--c-line2,rgba(255,255,255,.10))'}}><img src="/work/flyrlink-4.jpg" alt="Expert onboarding" loading="lazy" style={{position: 'absolute', inset: '0', width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} /></div><span style={{font: 'var(--weight-medium) 12.5px/1.4 var(--font-sans)', color: 'var(--c-dim,rgba(255,255,255,.48))'}}>Expert onboarding</span></div>
    </div>
    </section>
    ...
    <Link href="/aarniksha-solutions" data-cursor="grow" style={{display: 'flex', alignItems: 'center', gap: '8px', color: '#fff', font: 'var(--weight-medium) 13px/1 var(--font-sans)', letterSpacing: '.02em'}}>Next project: Aarniksha Solutions <span>→</span></Link>
