...
export default function FlyrlinkView() {
  ...
  return (
    ...
    <div data-r="1" data-r-now="1" data-r-d="60" style={{font: 'var(--weight-semibold) 11.5px/1 var(--font-sans)', letterSpacing: '.28em', textTransform: 'uppercase', color: 'var(--c-accent,#6BD5C6)'}}>Marketplace, booking, expert economy</div>
    ...
    <div data-r="1" data-r-d="60" style={{display: 'flex', alignItems: 'center', gap: '12px', background: 'var(--c-bg2,#17211F)', border: '1px solid var(--c-line2,rgba(255,255,255,.10))', borderRadius: '12px', padding: '20px 22px'}}><span style={{width: '7px', height: '7px', borderRadius: '50%', background: 'var(--c-accent,#6BD5C6)', flex: 'none'}}></span><span style={{font: 'var(--weight-medium) 15px/1.3 var(--font-display)', color: 'var(--c-h,#fff)'}}>Stronger trust</span></div>
