...
export default function DermSagaView() {
  ...
  return (
    ...
    <div data-r="1" data-r-now="1" style={{display: 'flex', alignItems: 'center', gap: '8px', font: 'var(--weight-medium) 11.5px/1 var(--font-mono)', letterSpacing: '.06em', color: 'var(--c-muted,rgba(255,255,255,.38))'}}><Link href="/" data-cursor="grow" style={{color: 'var(--c-muted,rgba(255,255,255,.38))'}}>Home</Link><span>/</span><Link href="/work" data-cursor="grow" style={{color: 'var(--c-muted,rgba(255,255,255,.38))'}}>Work</Link><span>/</span><span style={{color: 'var(--c-body2,rgba(255,255,255,.56))'}}>DermSaga</span></div>
    <div data-r="1" data-r-now="1" data-r-d="60" style={{font: 'var(--weight-semibold) 11.5px/1 var(--font-sans)', letterSpacing: '.28em', textTransform: 'uppercase', color: 'var(--c-accent,#4DA6FF)'}}>Healthcare, dermatology, patient experience</div>
    <h1 data-r="1" data-r-now="1" data-r-d="120" style={{fontFamily: '\'Instrument Serif\',Georgia,serif', fontWeight: '400', fontSize: 'clamp(34px,5.2vw,76px)', lineHeight: '1.04', letterSpacing: '-.008em', color: 'var(--c-h,#fff)', margin: '0', textWrap: 'balance', maxWidth: '20ch'}}>A More Confident Path to Care</h1>
    <p data-r="1" data-r-now="1" data-r-d="180" style={{font: 'var(--weight-regular) clamp(15px,1.2vw,18px)/1.7 var(--font-sans)', color: 'var(--c-body,rgba(255,255,255,.62))', maxWidth: '58ch'}}>UXVel connected specialist authority, patient education, treatment clarity, proof, and appointment access into a more confident healthcare journey.</p>
    <div data-r="1" data-r-now="1" data-r-d="240"><a href="https://dermsaga.com/" target="_blank" rel="noopener noreferrer" data-cursor="grow" data-mag="0.28" style={{display: 'inline-flex', alignItems: 'center', gap: '9px', color: 'var(--c-h,#fff)', font: 'var(--weight-medium) 13px/1 var(--font-sans)', letterSpacing: '.04em', padding: '13px 22px', borderRadius: '999px', border: '1px solid var(--c-line,rgba(255,255,255,.16))', transition: 'border-color .35s ease,background .35s ease'}} className="uxvh2">Visit DermSaga <span>↗</span></a></div>
    </div>
    </div>
    </section>
    ...
    <div data-r="1" style={{position: 'relative', borderRadius: '16px', overflow: 'hidden', aspectRatio: '16/9', width: '100%', border: '1px solid var(--c-line2,rgba(255,255,255,.10))'}}><img src="/work/dermsaga.jpg" alt="DermSaga case study cover" loading="lazy" style={{position: 'absolute', inset: '0', width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} /></div>
    ...
    <div style={{display: 'flex', flexDirection: 'column', gap: '8px'}}><span style={{font: 'var(--weight-semibold) 10.5px/1 var(--font-sans)', letterSpacing: '.2em', textTransform: 'uppercase', color: 'var(--c-muted,rgba(255,255,255,.38))'}}>Client</span><span style={{font: 'var(--weight-medium) 15px/1.4 var(--font-display)', color: 'var(--c-h,#fff)'}}>DermSaga</span></div>
    <div style={{display: 'flex', flexDirection: 'column', gap: '8px'}}><span style={{font: 'var(--weight-semibold) 10.5px/1 var(--font-sans)', letterSpacing: '.2em', textTransform: 'uppercase', color: 'var(--c-muted,rgba(255,255,255,.38))'}}>Industry</span><span style={{font: 'var(--weight-regular) 14.5px/1.4 var(--font-sans)', color: 'var(--c-body,rgba(255,255,255,.62))'}}>Healthcare, dermatology, patient experience</span></div>
    <div style={{display: 'flex', flexDirection: 'column', gap: '8px'}}><span style={{font: 'var(--weight-semibold) 10.5px/1 var(--font-sans)', letterSpacing: '.2em', textTransform: 'uppercase', color: 'var(--c-muted,rgba(255,255,255,.38))'}}>Scope</span><span style={{font: 'var(--weight-regular) 14.5px/1.4 var(--font-sans)', color: 'var(--c-body,rgba(255,255,255,.62))'}}>Patient journey, content, appointment flow</span></div>
    ...
    <p style={{font: 'var(--weight-regular) clamp(15px,1.15vw,17.5px)/1.75 var(--font-sans)', color: 'var(--c-body2,rgba(255,255,255,.56))'}}>DermSaga needed a healthcare experience that could communicate clinical authority while making treatment decisions easier for patients.</p>
    </div>
    ...
    <p style={{font: 'var(--weight-regular) clamp(15px,1.15vw,17.5px)/1.75 var(--font-sans)', color: 'var(--c-body2,rgba(255,255,255,.56))'}}>Patients researching dermatology care are often anxious and comparing options. Clinical credibility alone was not translating into booked appointments.</p>
    </div>
    ...
    <p style={{font: 'var(--weight-regular) clamp(15px,1.15vw,17.5px)/1.75 var(--font-sans)', color: 'var(--c-body2,rgba(255,255,255,.56))'}}>Confidence in a healthcare decision comes from a sequence: understanding the condition, trusting the specialist, seeing evidence of outcomes, and having an easy next step — in that order.</p>
    </div>
    ...
    <p style={{font: 'var(--weight-regular) clamp(15px,1.15vw,17.5px)/1.75 var(--font-sans)', color: 'var(--c-body2,rgba(255,255,255,.56))'}}>UXVel organized the journey around education, expertise, personalized care, proof, FAQs, and appointment access, reviewed with the clinic at every stage.</p>
    </div>
    </div>
    </div>
    </section>
    ...
    <div data-r="1" style={{background: 'var(--c-card,#0B1220)', padding: 'clamp(24px,2.6vw,36px)', display: 'flex', flexDirection: 'column', gap: '12px', minHeight: 'clamp(160px,16vw,200px)'}}><h3 style={{font: 'var(--weight-semibold) 15.5px/1.3 var(--font-display)', letterSpacing: '-.01em', color: 'var(--c-h,#fff)', margin: '0'}}>User journey</h3><p style={{font: 'var(--weight-regular) 14px/1.6 var(--font-sans)', color: 'var(--c-body2,rgba(255,255,255,.56))'}}>Structured from condition education through to appointment booking.</p></div>
    <div data-r="1" data-r-d="60" style={{background: 'var(--c-card,#0B1220)', padding: 'clamp(24px,2.6vw,36px)', display: 'flex', flexDirection: 'column', gap: '12px', minHeight: 'clamp(160px,16vw,200px)'}}><h3 style={{font: 'var(--weight-semibold) 15.5px/1.3 var(--font-display)', letterSpacing: '-.01em', color: 'var(--c-h,#fff)', margin: '0'}}>Content</h3><p style={{font: 'var(--weight-regular) 14px/1.6 var(--font-sans)', color: 'var(--c-body2,rgba(255,255,255,.56))'}}>Patient-education content reviewed and approved by the clinic.</p></div>
    <div data-r="1" data-r-d="120" style={{background: 'var(--c-card,#0B1220)', padding: 'clamp(24px,2.6vw,36px)', display: 'flex', flexDirection: 'column', gap: '12px', minHeight: 'clamp(160px,16vw,200px)'}}><h3 style={{font: 'var(--weight-semibold) 15.5px/1.3 var(--font-display)', letterSpacing: '-.01em', color: 'var(--c-h,#fff)', margin: '0'}}>Design system</h3><p style={{font: 'var(--weight-regular) 14px/1.6 var(--font-sans)', color: 'var(--c-body2,rgba(255,255,255,.56))'}}>A calm, clinical visual language built for trust, not alarm.</p></div>
    <div data-r="1" style={{background: 'var(--c-card,#0B1220)', padding: 'clamp(24px,2.6vw,36px)', display: 'flex', flexDirection: 'column', gap: '12px', minHeight: 'clamp(160px,16vw,200px)'}}><h3 style={{font: 'var(--weight-semibold) 15.5px/1.3 var(--font-display)', letterSpacing: '-.01em', color: 'var(--c-h,#fff)', margin: '0'}}>Lead / booking flow</h3><p style={{font: 'var(--weight-regular) 14px/1.6 var(--font-sans)', color: 'var(--c-body2,rgba(255,255,255,.56))'}}>A short, low-friction path to appointment enquiry.</p></div>
    </div>
    </div>
    </section>
    ...
    <div data-r="1" style={{display: 'flex', flexDirection: 'column', gap: '12px'}}><div style={{position: 'relative', borderRadius: '12px', overflow: 'hidden', aspectRatio: '16/10', border: '1px solid var(--c-line2,rgba(255,255,255,.10))'}}><img src="/work/dermsaga-1.jpg" alt="Patient education pages" loading="lazy" style={{position: 'absolute', inset: '0', width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} /></div><span style={{font: 'var(--weight-medium) 12.5px/1.4 var(--font-sans)', color: 'var(--c-dim,rgba(255,255,255,.48))'}}>Patient education pages</span></div>
    <div data-r="1" data-r-d="60" style={{display: 'flex', flexDirection: 'column', gap: '12px'}}><div style={{position: 'relative', borderRadius: '12px', overflow: 'hidden', aspectRatio: '16/10', border: '1px solid var(--c-line2,rgba(255,255,255,.10))'}}><img src="/work/dermsaga-2.jpg" alt="Appointment flow" loading="lazy" style={{position: 'absolute', inset: '0', width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} /></div><span style={{font: 'var(--weight-medium) 12.5px/1.4 var(--font-sans)', color: 'var(--c-dim,rgba(255,255,255,.48))'}}>Appointment flow</span></div>
    <div data-r="1" style={{display: 'flex', flexDirection: 'column', gap: '12px'}}><div style={{position: 'relative', borderRadius: '12px', overflow: 'hidden', aspectRatio: '16/10', border: '1px solid var(--c-line2,rgba(255,255,255,.10))'}}><img src="/work/dermsaga-3.jpg" alt="Specialist proof section" loading="lazy" style={{position: 'absolute', inset: '0', width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} /></div><span style={{font: 'var(--weight-medium) 12.5px/1.4 var(--font-sans)', color: 'var(--c-dim,rgba(255,255,255,.48))'}}>Specialist proof section</span></div>
    <div data-r="1" data-r-d="60" style={{display: 'flex', flexDirection: 'column', gap: '12px'}}><div style={{position: 'relative', borderRadius: '12px', overflow: 'hidden', aspectRatio: '16/10', border: '1px solid var(--c-line2,rgba(255,255,255,.10))'}}><img src="/work/dermsaga-4.jpg" alt="FAQs and patient resources" loading="lazy" style={{position: 'absolute', inset: '0', width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} /></div><span style={{font: 'var(--weight-medium) 12.5px/1.4 var(--font-sans)', color: 'var(--c-dim,rgba(255,255,255,.48))'}}>FAQs and patient resources</span></div>
    </div>
    </section>
    ...
    <Link href="/advyra" data-cursor="grow" style={{display: 'flex', alignItems: 'center', gap: '8px', color: '#fff', font: 'var(--weight-medium) 13px/1 var(--font-sans)', letterSpacing: '.02em'}}>Next project: Advyra <span>→</span></Link>
